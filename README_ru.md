...
## Отображение редактируемого/добавляемого объекта на карте
...
Библиотека позволяет делать дополнительные настройки отображения карты и объектов, задавая специальные свойства у класса модели и класса `django_admin_geomap.ModelAdmin`.
...
Свойство `geomap_popup_view` задает код для отображения пользователю без прав на изменения объекта, а свойство `geomap_popup_edit` - для пользователя, который имеет права на редактирование.
