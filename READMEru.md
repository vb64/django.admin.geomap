...
Если в списке содержится один объект, то центр карты устанавливается в координаты этого объекта, а масштаб карты устанавливается в значение парамтра автозуммирования (10 для примеров выше).

Если в списке содержится более одного объекта, программа определяет минимальный четырехугольник, вмещающий все отображаемые объекты.
Центр карты устанавливается в координаты центра этого четырехугольника.
Масштаб карты устанавливается таким образом, чтобы вместить данный четырехугольник с небольшими отступами по краям.
